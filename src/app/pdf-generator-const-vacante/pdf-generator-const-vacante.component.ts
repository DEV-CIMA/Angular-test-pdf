      ...
      content: [
        ...
        },
        {
          text: [
            ...
            'se asignará inmediatamente después que los padres o apoderados ' +
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              [
                'A.',
                'Certificado de Estudios en original del año inmediatamente anterior que acredites haber culminado satisfactoriamente',
              ],
        ...
        },
        {
          text: [
            '\nNo obstante lo contemplado anteriormente, esta constancia tendrá vigencia hasta el miércoles ' +
              this.fechaLimite +
              '. En caso sea necesario renovar este plazo, deberán ' +
              'solicitarlo.',
          ],
          style: 'text',
        },
