    ...
    if (this.inicial == true) {
      ...
      text2 = {
        text: [
          ...
          { text: this.vacante.años, bold: true, italics: true },
          ' del ',
          {
            text: this.niveles[0].descripcion.toUpperCase(),
            bold: true,
            italics: true,
          },
          '.',
        ...
        table: {
          body: [
            ...
            [
              ...
              {
                text: 'Copia de la Partida de Nacimiento del (la) postulante.',
                border: noBorder,
              },
              { text: '', border: noBorder },
            ],
            ...
            [
              ...
              {
                text:
                  'Suscribir el Contrato de Servicios Educativos del año escolar ' +
                  this.vacante.anioPosterior +
                  '.',
                border: noBorder,
              },
              { text: '', border: noBorder },
            ...
            [
              ...
              {
                text:
                  'Declaración Jurada de los padres o apoderado año escolar ' +
                  this.vacante.anioPosterior +
                  '.',
                border: noBorder,
              },
      ...
      text2 = {
        text: [
          ...
          { text: 'vacante provisional', bold: true, italics: true },
          ' en nuestra institucion Educativa para  ',
          { text: this.vacante.grado, bold: true, italics: true },
          ' del ',
          {
            text: this.niveles[1].descripcion.toUpperCase(),
            bold: true,
            italics: true,
          },
          '.',
        ...
        table: {
          body: [
            [
              ...
              { text: 'A.', border: noBorder },
              {
                text: 'Certificado de Estudios en original del año inmediatamente anterior que acredite haber culminado satisfactoriamente.',
                border: noBorder,
              },
              { text: '*\t*', color: 'white', border: noBorder },
            ],
            [
              ...
              { text: 'B.', border: noBorder },
              {
                text: 'Ficha única de matrícula generada por el SIAGIE.',
                border: noBorder,
              },
              { text: '', border: noBorder },
            ],
      ...
      text2 = {
        text: [
          ...
          ' del ',
          {
            text: this.niveles[2].descripcion.toUpperCase(),
            bold: true,
            italics: true,
          },
          '.',
    ...
    this.docDefinition = {
      ...
      content: [
        ...
        text2,
        {
          text: [
            '\nLa ',
            { text: 'Vacante definitiva', bold: true, italics: true },
        ...
        },
        {
          ...
          table: {
            body: [
              [
                {
                  text: 'Prof. ' + this.vacante.remitente,
                  bold: true,
