  ...
  generatePDF() {
    ...
    this.docDefinition = {
        ...
        content: [
                  ...
                  {
                    text:['Yo, ______________________________, identificada(o) con DNI N° ________________,'+
                  ...
                  {
                    text:['Que actualmente soy trabajador(a) independiente, desempeñandome como '+
