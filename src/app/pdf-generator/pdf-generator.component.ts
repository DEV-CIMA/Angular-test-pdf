  ...
  generatePDF() {  
    ...
    this.docDefinition = {
      ...
      content: [
          ...
          table: {
            body: [
              ...
              [ { text: [
                  ...
                  color: 'white', colSpan: 9, fontSize: 4 }, '', '', '', '', '', '', '', ''
              ]
            ]
          },
        },
        ...
        { layout: {
            hLineColor: () => {
              const campos = [1, 3, 5, 7, 9, 11, 14, 16, 18, 21, 23, 26, 28, 31, 33, 38, 40, 42, 44, 46, 49, 50];
              counter++;
              if (campos.includes(counter)) return 'white';
                else {
        ...
        { columns: [ 
          { columns: [ { width: 120, text: ' ' } ,{
              ...
              table: { body: [[{ text: 'FIRMA', border: [ false, true, false, false ] }]] },
              fontSize: 11,
              margin  : [0, 60, 0, 0]
            }]
          },
